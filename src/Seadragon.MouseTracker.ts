...
export class MouseTracker {
    public lteIE8: boolean

    constructor() {
        // update: IE9 implements the W3C standard event model! =)
        this.lteIE8 = Utils.getBrowser() == SeadragonBrowser.IE &&
            Utils.getBrowserVersion() < 9;
    ...
    SeadragonMouseTracker = Seadragon.MouseTracker = function(elmt) {
        ...
        function startTracking() {
            if (!tracking) {
                ...
                Utils.addEvent(elmt, "mousewheel", onMouseScroll, false);
        ...
        function stopTracking() {
            if (tracking) {
                ...
                Utils.removeEvent(elmt, "mousewheel", onMouseScroll, false);
        ...
        function onMouseScroll(event) {
            var event = Utils.getEvent(event);
            var delta = Utils.getMouseScroll(event);
