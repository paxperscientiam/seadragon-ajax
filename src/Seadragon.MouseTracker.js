...
var Seadragon_Utils_1 = require("./Seadragon.Utils");
var MouseTracker = /** @class */ (function () {
    function MouseTracker() {
        this.SeadragonMouseTracker = Seadragon.MouseTracker = function (elmt) {
            // Fields
            var self = this;
            var ieSelf = null;
            var hash = Math.random(); // a unique hash for this tracker
            var elmt = Seadragon_Utils_1.Utils.getElement(elmt);
            var tracking = false;
            var capturing = false;
            ...
            function startTracking() {
                if (!tracking) {
                    Seadragon_Utils_1.Utils.addEvent(elmt, "mouseover", onMouseOver, false);
                    Seadragon_Utils_1.Utils.addEvent(elmt, "mouseout", onMouseOut, false);
                    Seadragon_Utils_1.Utils.addEvent(elmt, "mousedown", onMouseDown, false);
                    Seadragon_Utils_1.Utils.addEvent(elmt, "mouseup", onMouseUp, false);
                    Seadragon_Utils_1.Utils.addEvent(elmt, "mousewheel", onMouseScroll, false);
                    Seadragon_Utils_1.Utils.addEvent(elmt, "click", onMouseClick, false);
                    tracking = true;
            ...
            function stopTracking() {
                if (tracking) {
                    Seadragon_Utils_1.Utils.removeEvent(elmt, "mouseover", onMouseOver, false);
                    Seadragon_Utils_1.Utils.removeEvent(elmt, "mouseout", onMouseOut, false);
                    Seadragon_Utils_1.Utils.removeEvent(elmt, "mousedown", onMouseDown, false);
                    Seadragon_Utils_1.Utils.removeEvent(elmt, "mouseup", onMouseUp, false);
                    Seadragon_Utils_1.Utils.removeEvent(elmt, "mousewheel", onMouseScroll, false);
                    Seadragon_Utils_1.Utils.removeEvent(elmt, "click", onMouseClick, false);
                    releaseMouse();
                    tracking = false;
            ...
            function captureMouse() {
                if (!capturing) {
                    ...
                    if (lteIE8) {
                        ...
                        Seadragon_Utils_1.Utils.removeEvent(elmt, "mouseup", onMouseUp, false);
                        Seadragon_Utils_1.Utils.addEvent(elmt, "mouseup", onMouseUpIE, true);
                        Seadragon_Utils_1.Utils.addEvent(elmt, "mousemove", onMouseMoveIE, true);
                    }
                    else {
                        Seadragon_Utils_1.Utils.addEvent(window, "mouseup", onMouseUpWindow, true);
                        Seadragon_Utils_1.Utils.addEvent(window, "mousemove", onMouseMove, true);
                    }
                    capturing = true;
                }
            }
            function releaseMouse() {
                if (capturing) {
                    ...
                    if (lteIE8) {
                        ...
                        Seadragon_Utils_1.Utils.removeEvent(elmt, "mousemove", onMouseMoveIE, true);
                        Seadragon_Utils_1.Utils.removeEvent(elmt, "mouseup", onMouseUpIE, true);
                        Seadragon_Utils_1.Utils.addEvent(elmt, "mouseup", onMouseUp, false);
                    }
                    else {
                        Seadragon_Utils_1.Utils.removeEvent(window, "mousemove", onMouseMove, true);
                        Seadragon_Utils_1.Utils.removeEvent(window, "mouseup", onMouseUpWindow, true);
                    }
                    capturing = false;
                }
            }
            ...
            function onMouseOver(event) {
                var event = Seadragon_Utils_1.Utils.getEvent(event);
            ...
            function onMouseDown(event) {
                ...
                if (self.pressHandler || self.dragHandler) {
                    ...
                    Seadragon_Utils_1.Utils.cancelEvent(event);
                }
            ...
            function onMouseUpIE(event) {
                ...
                Seadragon_Utils_1.Utils.stopEvent(event);
            }
            /**
            ...
            function onMouseScroll(event) {
                var event = Seadragon_Utils_1.Utils.getEvent(event);
                var delta = Seadragon_Utils_1.Utils.getMouseScroll(event);
        ...
        this.lteIE8 = Seadragon_Utils_1.Utils.getBrowser() == SeadragonBrowser.IE &&
            Seadragon_Utils_1.Utils.getBrowserVersion() < 9;
        // Static fields
        ...
        if (this.lteIE8) {
            Seadragon_Utils_1.Utils.addEvent(document, "mousedown", onGlobalMouseDown, false);
            Seadragon_Utils_1.Utils.addEvent(document, "mouseup", onGlobalMouseUp, false);
        }
        else {
            Seadragon_Utils_1.Utils.addEvent(window, "mousedown", onGlobalMouseDown, true);
            Seadragon_Utils_1.Utils.addEvent(window, "mouseup", onGlobalMouseUp, true);
        }
    }
    // Static helpers
    MouseTracker.prototype.getMouseAbsolute = function (event) {
        return Seadragon_Utils_1.Utils.getMousePosition(event);
    };
    MouseTracker.prototype.getMouseRelative = function (event, elmt) {
        var mouse = Seadragon_Utils_1.Utils.getMousePosition(event);
        var offset = Seadragon_Utils_1.Utils.getElementPosition(elmt);
        return mouse.minus(offset);
    };
    /**
     * Returns true if elmtB is a child node of elmtA, or if they're equal.
     */
    MouseTracker.prototype.isChild = function (elmtA, elmtB) {
    ...
    MouseTracker.prototype.onGlobalMouseDown = function () {
        buttonDownAny = true;
    };
    MouseTracker.prototype.onGlobalMouseUp = function () {
        buttonDownAny = false;
    };
    return MouseTracker;
}());
